...
NAME=nsk2
MARC_DIR=${BASE_INPUT_DIR}/nsk2
# OUTPUT_DIR=/home/pkiraly/data/marc21/output/nsk2

echo "BASE_OUPUT_DIR: ${BASE_OUPUT_DIR}"
echo "OUTPUT_DIR: ${OUTPUT_DIR}"
# MARC_DIR=${BASE_INPUT_DIR}/current
TYPE_PARAMS="--emptyLargeCollectors --marcxml"
TYPE_PARAMS="${TYPE_PARAMS} --id file:/home/pkiraly/Documents/research/peni/identifiers.csv"
# 911
