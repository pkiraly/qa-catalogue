...
#library(magrittr)
library(dplyr)
#' Reads shelf-ready-completeness.csv and creates histogram files for all
#' column. The files are saved under the BASE_OUTPUT_DIR directory specified
#' in setdir.sh in shelf-ready-completeness-histogram-[column name].csv name form where
...
#' system("Rscript scripts/shelf-ready-histogram.R [directory-of-shelf-ready-completeness.csv]")
...
prefix <- 'shelf-ready-completeness'
