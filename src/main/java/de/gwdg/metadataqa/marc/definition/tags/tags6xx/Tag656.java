...
/**
 * Index Term - Occupation http://www.loc.gov/marc/bibliographic/bd656.html
 */
public class Tag656 extends DataFieldDefinition {
    ...
    private void initialize() {
        ...
        setSubfieldsWithCardinality("a", "Occupation", "NR", "k", "Form", "NR", "v", "Form subdivision", "R", "x",
                "General subdivision", "R", "y", "Chronological subdivision", "R", "z", "Geographic subdivision", "R",
                "0", "Authority record control number", "R", "2", "Source of term", "NR", "3", "Materials specified",
        ...
        getSubfield("a").setBibframeTag("occupation").setFrbrFunctions(DiscoverySearch, DiscoveryIdentify)
