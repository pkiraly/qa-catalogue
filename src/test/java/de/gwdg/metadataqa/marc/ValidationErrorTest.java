...
public class ValidationErrorTest {
  ...
  public void testBasics() {
    ValidationError error = new ValidationError("123", "007/01", ValidationErrorType.CONTROL_POSITION_OBSOLETE_CODE,
    ...
    assertEquals(ValidationErrorType.CONTROL_POSITION_OBSOLETE_CODE, error.getType());
  ...
  public void testComparision() {
    ValidationError error1 = new ValidationError("123", "007/01", ValidationErrorType.CONTROL_POSITION_OBSOLETE_CODE,
      "c", Tag007nonprojected01.getInstance().getDescriptionUrl());
    ValidationError error2 = new ValidationError("123", "007/01", ValidationErrorType.CONTROL_POSITION_OBSOLETE_CODE,
      "c", Tag007nonprojected01.getInstance().getDescriptionUrl());
  ...
  public void testComparision_givenDifferentIds() {
    ...
    ValidationError error1 = new ValidationError("123", "008/06 (tag008all06)", ValidationErrorType.CONTROL_POSITION_INVALID_VALUE,
      " ", Tag008all06.getInstance().getDescriptionUrl());
    ValidationError error2 = new ValidationError("124", "008/06 (tag008all06)", ValidationErrorType.CONTROL_POSITION_INVALID_VALUE,
      " ", Tag008all06.getInstance().getDescriptionUrl());
  ...
  public void testCollector() {
    ...
    ValidationError error2 = new ValidationError("124", "007/01", ValidationErrorType.CONTROL_POSITION_OBSOLETE_CODE,
      "c", Tag007nonprojected01.getInstance().getDescriptionUrl());
