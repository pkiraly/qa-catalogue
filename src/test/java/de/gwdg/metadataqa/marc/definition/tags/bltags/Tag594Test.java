...
public class Tag594Test {
  ...
  public void validField(String subfield, String value) {
    DataField field = new DataField(Tag594.getInstance(), " ", " ", subfield, value);

    MarcRecord record = new MarcRecord("test");
    field.setRecord(record);

    assertFalse(
      String.format("594$%s=%s should be invalid in normal case", subfield, value),
      field.validate(MarcVersion.MARC21));
    assertTrue(
      String.format("594$%s=%s should be valid in normal case", subfield, value),
  ...
  public void invalidField(String ind1, String subfield, String value) {
    DataField field = new DataField(Tag594.getInstance(), ind1, " ", subfield, value);
    ...
    assertFalse(
      ...
      field.validate(MarcVersion.MARC21));
    assertFalse(
      String.format("594$%s=%s should be invalid in BL", subfield, value),
      field.validate(MarcVersion.BL));
  }
}
