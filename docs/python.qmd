...
As probably visible from the example, the connector provides an event-driven approach.
The Java PythonGateway Java class accepts a class that
implements the MinimalProcessor interface (events happens during the reading of input data),
and [general parameters](usage.html#general-parameters). The process calls the Processor's
