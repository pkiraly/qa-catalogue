...
public class Tag753 extends DataFieldDefinition {
  ...
  private void initialize() {
    ...
    setSubfieldsWithCardinality("a", "Make and model of machine", "NR", "b", "Programming language", "NR", "c",
        "Operating system", "NR", "0", "Authority record control number or standard number", "R", "2", "Source of term",
        "NR", "6", "Linkage", "NR", "8", "Field link and sequence number", "R");
    ...
    getSubfield("a").setBibframeTag("machineModel").setFrbrFunctions(DiscoverySearch, DiscoveryIdentify)
        .setCompilanceLevels("M");

    getSubfield("b").setBibframeTag("programmingLanguage").setFrbrFunctions(DiscoverySearch, DiscoveryIdentify)
        .setCompilanceLevels("A");

    getSubfield("c").setBibframeTag("operatingSystem").setFrbrFunctions(DiscoverySearch, DiscoveryIdentify)
        .setCompilanceLevels("A");
