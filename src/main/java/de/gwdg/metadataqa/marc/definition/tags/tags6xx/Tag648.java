...
public class Tag648 extends DataFieldDefinition {
    ...
    private void initialize() {
        ...
        ind1 = new Indicator().setHistoricalCodes(" ", "No information provided [OBSOLETE, 2014]", "0",
                "Date or time period depicted [OBSOLETE, 2014]", "1",
                "Date or time period of creation or origin [OBSOLETE, 2014]");
        ...
        setSubfieldsWithCardinality("a", "Chronological term", "NR", "v", "Form subdivision", "R", "x",
