...
/**
 * Index Term - Genre/Form http://www.loc.gov/marc/bibliographic/bd655.html
 */
public class Tag655 extends DataFieldDefinition {
    ...
    private void initialize() {
        ...
        ind1 = new Indicator("Type of heading").setCodes(" ", "Basic", "0", "Faceted").setMqTag("type")
        ...
        setSubfieldsWithCardinality("a", "Genre/form data or focus term", "NR", "b", "Non-focus term", "R", "c",
                "Facet/hierarchy designation", "R", "v", "Form subdivision", "R", "x", "General subdivision", "R", "y",
                ...
                "5", "Institution to which field applies", "NR", "6", "Linkage", "NR", "8",
        ...
        getSubfield("a").setBibframeTag("rdfs:label").setMqTag("rdf:value")
                .setFrbrFunctions(DiscoverySearch, DiscoveryIdentify).setCompilanceLevels("M");

        getSubfield("b").setMqTag("nonfocusTerm").setFrbrFunctions(DiscoverySearch, DiscoveryIdentify)
                .setCompilanceLevels("M");

        getSubfield("c").setMqTag("facet").setFrbrFunctions(ManagementIdentify, ManagementProcess)
                .setCompilanceLevels("M");
        ...
        getSubfield("5").setMqTag("institutionToWhichFieldApplies").setFrbrFunctions(ManagementProcess)
                .setCompilanceLevels("O");
